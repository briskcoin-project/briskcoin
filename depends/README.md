...
Briskcoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Briskcoin Core

**When configuring Briskcoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Briskcoin Core:
...
variables will be set when generating the Briskcoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
