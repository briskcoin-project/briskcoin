...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/briskcoin/briskcoin/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(BriskcoinTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/briskcoin/briskcoin/issues/27380
