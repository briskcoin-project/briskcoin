...
class FilelockTest(BriskcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Check that cookie and PID file are not deleted when attempting to start a second briskcoind using the same datadir")
        cookie_file = datadir / ".cookie"
        assert cookie_file.exists()  # should not be deleted during the second briskcoind instance shutdown
        pid_file = datadir / "briskcoind.pid"
