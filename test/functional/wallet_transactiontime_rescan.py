...
class TransactionTimeRescanTest(BriskcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BKC and create transactions
        ...
        # generate some bkc to create transactions and check blockcount
        ...
        # send 10 bkc to user's first watch-only address
        self.log.info('Send 10 bkc to user')
        ...
        # send 5 bkc to our second watch-only address
        self.log.info('Send 5 bkc to user')
        ...
        # send 1 bkc to our third watch-only address
        self.log.info('Send 1 bkc to user')
