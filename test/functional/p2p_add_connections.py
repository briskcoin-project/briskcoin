...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The briskcoind node closes feeler connections as soon as a version
...
class P2PAddConnections(BriskcoinTestFramework):
    ...
    def run_test(self):
        ...
        # briskcoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that briskcoind sends its own version prior to processing
