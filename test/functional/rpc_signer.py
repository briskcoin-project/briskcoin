...
Verify that a briskcoind node can use an external signer command.
...
class RPCSignerTest(BriskcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart briskcoind with -signer=<cmd>',
