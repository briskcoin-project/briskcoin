...
# Copyright 2016-present The Briskcoin Core developers
...
class ToolUtils(BriskcoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        self.skip_if_no_briskcoin_tx()
        self.skip_if_no_briskcoin_util()

    def run_test(self):
        self.testcase_dir = Path(self.config["environment"]["SRCDIR"]) / "test" / "functional" / "data" / "util"
        self.bins = self.get_binaries()
        with open(self.testcase_dir / "briskcoin-util-test.json", encoding="utf8") as f:
