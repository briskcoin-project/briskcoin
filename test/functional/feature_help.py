#!/usr/bin/env python3
# Copyright (c) 2018-2021 The Briskcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting briskcoin with -h works as expected."""

from test_framework.test_framework import BriskcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BriskcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start briskcoin with -h for help text")
        ...
        self.log.info("Start briskcoin with -version for version information")
        ...
        self.log.info("Start briskcoind with -fakearg to make sure it does not start")
