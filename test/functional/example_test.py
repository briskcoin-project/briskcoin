...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BriskcoinTestFramework
    pass


class ExampleTest(BriskcoinTestFramework):
    # Each functional test is a subclass of the BriskcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BriskcoinTestFramework class so other tests can use it."""
