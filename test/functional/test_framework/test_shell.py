...
class TestShell:
    """Wrapper Class for BriskcoinTestFramework.

    The TestShell class extends the BriskcoinTestFramework
    ...
    class __TestShell(BriskcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BriskcoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # BriskcoinTestFramework instances are supposed to be constructed with the path
