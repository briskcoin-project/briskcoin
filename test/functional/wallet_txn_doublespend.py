...
class TxnMallTest(BriskcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BKC:
        ...
        # First: use raw transaction API to send 1240 BKC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BKC coin each
        ...
        # Node0's balance should be starting balance, plus 50BKC for another
        ...
        # Node0's total balance should be starting balance, plus 100BKC for
