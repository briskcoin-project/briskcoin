...
class BriskcoinChainstateTest(BriskcoinTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_briskcoin_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing briskcoin-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    BriskcoinChainstateTest(__file__).main()
