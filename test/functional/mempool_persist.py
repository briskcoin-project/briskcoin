...
By default, briskcoind will dump mempool on shutdown and
...
class MempoolPersistTest(BriskcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent briskcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
