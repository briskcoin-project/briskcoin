...
```
$ python3 contrib/tracing/p2p_monitor.py ./src/briskcoind
```
...
```
$ python3 contrib/tracing/log_raw_p2p_msgs.py ./src/briskcoind
```
...
```bash
$ python3 contrib/tracing/log_utxocache_flush.py ./src/briskcoind
```
...
```console
$ python3 contrib/tracing/mempool_monitor.py ./src/briskcoind
```
