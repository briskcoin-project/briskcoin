...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BRISKCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define BRISKCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the briskcoin network\n')
    ...
    g.write('#endif // BRISKCOIN_CHAINPARAMSSEEDS_H\n')
