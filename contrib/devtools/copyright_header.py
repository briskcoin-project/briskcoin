...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The Briskcoin Core developers",
    r"BitPay Inc\.",
    r"Pieter Wuille",
...
Arguments:
    <base_directory> - The base directory of a briskcoin source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Briskcoin Core developers'
...
CPP_HEADER = '''
// Copyright (c) %s The Briskcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Briskcoin Core developers'
                 % (filename))
...
Arguments:
    <file> - A source file in the briskcoin repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Briskcoin
