...
# Extract options
function __fish_briskcoin_tx_get_options
...
# Extract commands
function __fish_briskcoin_tx_get_commands
...
# Add options
complete \
    --command briskcoin-tx \
    --condition "not __fish_briskcoin_seen_cmd (__fish_briskcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_briskcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command briskcoin-tx \
    --arguments "(__fish_briskcoin_tx_get_commands)" \
    --no-files
