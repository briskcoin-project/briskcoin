...
complete --command briskcoin-qt --no-files

# Extract options
function __fish_briskcoinqt_get_options
...
complete \
    --command briskcoin-qt \
    --arguments "(__fish_briskcoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c briskcoin-qt \
...
complete \
    --command briskcoin-qt \
    --arguments "(__fish_briskcoinqt_get_options --nofiles)"
