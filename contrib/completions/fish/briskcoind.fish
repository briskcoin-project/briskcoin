...
complete --command briskcoind --no-files

# Extract options
function __fish_briskcoind_get_options
...
complete \
    --command briskcoind \
    --arguments "(__fish_briskcoind_get_options --nofiles)"
