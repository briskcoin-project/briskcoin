...
#ifndef BRISKCOIN_TEST_SCRIPTNUM10_H
#define BRISKCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Briskcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BRISKCOIN_TEST_SCRIPTNUM10_H
