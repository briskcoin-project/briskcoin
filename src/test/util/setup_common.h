// Copyright (c) 2015-present The Briskcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BRISKCOIN_TEST_UTIL_SETUP_COMMON_H
#define BRISKCOIN_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/briskcoin/briskcoin/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // BRISKCOIN_TEST_UTIL_SETUP_COMMON_H
