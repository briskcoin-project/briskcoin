...
#ifndef BRISKCOIN_TEST_UTIL_CLUSTER_LINEARIZE_H
#define BRISKCOIN_TEST_UTIL_CLUSTER_LINEARIZE_H
    ...
    void Unser(Stream& s, DepGraph<SetType>& depgraph)
    {
        ...
        try {
            while (true) {
                ...
                uint64_t coded_fee;
                s >> VARINT(coded_fee);
                coded_fee &= 0xFFFFFFFFFFFFF; // Enough for fee between -21M...21M BKC.
...
#endif // BRISKCOIN_TEST_UTIL_CLUSTER_LINEARIZE_H
