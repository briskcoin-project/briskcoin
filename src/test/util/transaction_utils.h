// Copyright (c) 2019-2020 The Briskcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BRISKCOIN_TEST_UTIL_TRANSACTION_UTILS_H
#define BRISKCOIN_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // BRISKCOIN_TEST_UTIL_TRANSACTION_UTILS_H
