...
{
    BOOST_CHECK(TestSplitHost("www.briskcoincore.org", "www.briskcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.briskcoincore.org]", "www.briskcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.briskcoincore.org:80", "www.briskcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.briskcoincore.org]:80", "www.briskcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.briskcoincore.org:65536", "www.briskcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.briskcoincore.org:0", "www.briskcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.briskcoincore.org:", "www.briskcoincore.org:", 0, false));
}
