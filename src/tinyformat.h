...
#include <algorithm>
#include <attributes.h> // Added for Briskcoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Briskcoin Core
#include <util/string.h> // Added for Briskcoin Core
...
// Added for Briskcoin Core. Similar to std::runtime_format from C++26.
...
// Added for Briskcoin Core. Wrapper for checking format strings at compile time.
