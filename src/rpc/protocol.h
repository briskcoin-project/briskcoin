...
#ifndef BRISKCOIN_RPC_PROTOCOL_H
#define BRISKCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in briskcoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Briskcoin is not connected
...
#endif // BRISKCOIN_RPC_PROTOCOL_H
