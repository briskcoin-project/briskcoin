...
#### Added
  - Added tests against [Project Wycheproof's](https://github.com/google/wycheproof/) set of ECDSA test vectors (Briskcoin "low-S" variant), a fixed set of test cases designed to trigger various edge cases.
