// Copyright (c) 2015-2021 The Briskcoin Core developers
 ...
 */
#ifndef BRISKCOIN_TORCONTROL_H
#define BRISKCOIN_TORCONTROL_H
...
/****** Briskcoin specific TorController implementation ********/
