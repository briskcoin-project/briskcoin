...
#ifndef BRISKCOIN_COMMON_SIGNMESSAGE_H
#define BRISKCOIN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's briskcoin address, it must refer to a public key.
...
#endif // BRISKCOIN_COMMON_SIGNMESSAGE_H
