...
#ifndef BRISKCOIN_COMMON_SETTINGS_H
#define BRISKCOIN_COMMON_SETTINGS_H
...
//!       https://github.com/briskcoin/briskcoin/pull/15934/files#r337691812)
...
#endif // BRISKCOIN_COMMON_SETTINGS_H
