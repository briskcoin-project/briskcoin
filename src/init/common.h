...
//! @file
//! @brief Common init functions shared by briskcoin-node, briskcoin-wallet, etc.

#ifndef BRISKCOIN_INIT_COMMON_H
#define BRISKCOIN_INIT_COMMON_H
