...
#ifndef BRISKCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
#define BRISKCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
...
#endif // BRISKCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
