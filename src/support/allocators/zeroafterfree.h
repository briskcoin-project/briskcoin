...
#ifndef BRISKCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BRISKCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BRISKCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
