...
#ifndef BRISKCOIN_TXGRAPH_H
#define BRISKCOIN_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvingbriskcoin.org/t/introduction-to-cluster-linearization/1032
 *
