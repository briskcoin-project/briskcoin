...
#ifndef BRISKCOIN_ARITH_UINT256_H
#define BRISKCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Briskcoin only uses this "compact" format for encoding difficulty
...
#endif // BRISKCOIN_ARITH_UINT256_H
