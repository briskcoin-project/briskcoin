...
#ifndef BRISKCOIN_PSBT_H
#define BRISKCOIN_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual Briskcoin transaction.) Returns true if the merge succeeded, false otherwise. */
