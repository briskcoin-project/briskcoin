...
#ifndef BRISKCOIN_TXREQUEST_H
#define BRISKCOIN_TXREQUEST_H
 ...
 *   specific transaction. See https://briskcoincore.org/en/2024/07/03/disclose_already_asked_for.
 */
