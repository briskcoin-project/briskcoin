...
// Copyright 2015 Briskcoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef BRISKCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
#define BRISKCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // BRISKCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
