...
#ifndef BRISKCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define BRISKCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // BRISKCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
