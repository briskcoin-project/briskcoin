...
const QString BITCOIN_IPC_PREFIX("briskcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/briskcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/briskcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/briskcoin-paymentrequest";
