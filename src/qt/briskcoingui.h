...
#ifndef BRISKCOIN_QT_BRISKCOINGUI_H
#define BRISKCOIN_QT_BRISKCOINGUI_H
...
/**
  Briskcoin GUI main class. This class represents the main window of the Briskcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BriskcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BriskcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BriskcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a briskcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BriskcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Briskcoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(BriskcoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // BRISKCOIN_QT_BRISKCOINGUI_H
