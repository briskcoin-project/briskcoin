...
#ifndef BRISKCOIN_QT_BRISKCOINUNITS_H
#define BRISKCOIN_QT_BRISKCOINUNITS_H
...
/** Briskcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BriskcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BriskcoinUnits(QObject *parent);

    /** Briskcoin units.
      @note Source: https://en.briskcoin.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        BKC,
        mBKC,
