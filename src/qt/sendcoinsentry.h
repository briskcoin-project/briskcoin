...
#ifndef BRISKCOIN_QT_SENDCOINSENTRY_H
#define BRISKCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending briskcoins.
 */
...
#endif // BRISKCOIN_QT_SENDCOINSENTRY_H
