...
/** Main Briskcoin application object */
class BriskcoinApplication: public QApplication
{
    Q_OBJECT
public:
    explicit BriskcoinApplication();
    ~BriskcoinApplication();
    ...
    /// Get window identifier of QMainWindow (BriskcoinGUI)
...
Q_SIGNALS:
    ...
    void windowShown(BriskcoinGUI* window);
...
#endif // BRISKCOIN_QT_BRISKCOIN_H
