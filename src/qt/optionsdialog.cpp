      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->briskcoinAtStartup->setToolTip(ui->briskcoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->briskcoinAtStartup->setText(ui->briskcoinAtStartup->text().arg(CLIENT_NAME));

    ui->openBriskcoinConfButton->setToolTip(ui->openBriskcoinConfButton->toolTip().arg(CLIENT_NAME));
