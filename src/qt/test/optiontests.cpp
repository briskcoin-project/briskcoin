...
{
    // Test regression https://github.com/briskcoin/briskcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/briskcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/briskcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Briskcoin/Briskcoin-Qt.conf and all else left as default,
    // briskcoin-qt should set both -listen and -listenonion to false and start successfully.
