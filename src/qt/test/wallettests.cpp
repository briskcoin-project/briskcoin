...
//
//     QT_QPA_PLATFORM=xcb     build/bin/test_briskcoin-qt  # Linux
//     QT_QPA_PLATFORM=windows build/bin/test_briskcoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   build/bin/test_briskcoin-qt  # macOS
