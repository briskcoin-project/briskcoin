...
#ifndef BRISKCOIN_QT_GUIUTIL_H
#define BRISKCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Briskcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "briskcoin:" URI into recipient object, return true on successful parsing
