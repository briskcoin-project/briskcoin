...
#ifndef BRISKCOIN_QT_WALLETVIEW_H
#define BRISKCOIN_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a briskcoin wallet, and offers access to
...
#endif // BRISKCOIN_QT_WALLETVIEW_H
