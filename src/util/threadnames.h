// Copyright (c) 2018-2019 The Briskcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BRISKCOIN_UTIL_THREADNAMES_H
#define BRISKCOIN_UTIL_THREADNAMES_H
...
#endif // BRISKCOIN_UTIL_THREADNAMES_H
