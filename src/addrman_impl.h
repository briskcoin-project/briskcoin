...
#ifndef BRISKCOIN_ADDRMAN_IMPL_H
#define BRISKCOIN_ADDRMAN_IMPL_H
 ...
 * see https://briskcoincore.org/en/2024/07/31/disclose-addrman-int-overflow/
 */
...
#endif // BRISKCOIN_ADDRMAN_IMPL_H
