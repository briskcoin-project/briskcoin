...
extern thread_local ThreadContext g_thread_context; // NOLINT(briskcoin-nontrivial-threadlocal)
// Silence nonstandard briskcoin tidy error "Variable with non-trivial destructor
