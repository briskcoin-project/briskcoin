...
#ifndef BRISKCOIN_IPC_CAPNP_COMMON_TYPES_H
#define BRISKCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between briskcoin processes.
...
//! Functions to serialize / deserialize common briskcoin types.
namespace mp {
...
#endif // BRISKCOIN_IPC_CAPNP_COMMON_TYPES_H
