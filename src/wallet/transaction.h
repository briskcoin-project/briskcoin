...
#ifndef BRISKCOIN_WALLET_TRANSACTION_H
#define BRISKCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this briskcoin node, and set to 0 for transactions that were created
...
#endif // BRISKCOIN_WALLET_TRANSACTION_H
