...
#ifndef BRISKCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BRISKCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BRISKCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
