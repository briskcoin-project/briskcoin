...
#ifndef BRISKCOIN_POLICY_FEERATE_H
#define BRISKCOIN_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "BKC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BKC_KVB,      //!< Use BKC/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BKC_KVB) const;
...
#endif // BRISKCOIN_POLICY_FEERATE_H
