...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("0482f7a5b9c91a8635f3c6247d9278864411151a3a4b403cacddc62f2e1bad1e349c09e5c6679364f2409d9f83b996c37f92453ec3bfd283afb457cc8957f047d1") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.script_flag_exceptions.emplace( // BIP16 exception
            uint256{"00000aa939743c8cde8eaf22400462f42388ea665ae391202c7215f22c3ead17"}, SCRIPT_VERIFY_NONE);
        consensus.script_flag_exceptions.emplace( // Taproot exception
            uint256{"00000aa939743c8cde8eaf22400462f42388ea665ae391202c7215f22c3ead17"}, SCRIPT_VERIFY_P2SH | SCRIPT_VERIFY_WITNESS);
        consensus.BIP34Height = 1;
        consensus.BIP34Hash = uint256{"00000aa939743c8cde8eaf22400462f42388ea665ae391202c7215f22c3ead17"};
        ...
        checkpointData = {
            {
                { 2, uint256{"00000f622a1942f072b1128d01ba9861e7df85a7eb22773433f0bd468d9a534d"}},
            }
        };
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        checkpointData = {
            {
                {0, uint256{"4d7328373020ed6dbd37d72a0803b23c6a9262e74f00440c8c1e5a3b690d1b9e"}},
            }
        };
