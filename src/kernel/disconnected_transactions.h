...
#ifndef BRISKCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define BRISKCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // BRISKCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
