 ...
 * src/qt/guiutil.cpp and src/briskcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Briskcoin’s Peer-to-Peer Network")
...
#endif // BRISKCOIN_NODE_CONNECTION_TYPES_H
