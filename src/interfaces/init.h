...
#ifndef BRISKCOIN_INTERFACES_INIT_H
#define BRISKCOIN_INTERFACES_INIT_H
...
//! (briskcoin-gui, briskcoin-node, briskcoin-wallet, briskcoind, briskcoin-qt) and each
...
#endif // BRISKCOIN_INTERFACES_INIT_H
