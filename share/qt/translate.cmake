...
function(extract_strings output)
  ...
  file(STRINGS "briskcoinstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *briskcoin_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"briskcoin-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/briskcoinstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/briskcoinstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/briskcoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/briskcoin_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/briskcoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/briskcoin_en.xlf" briskcoin_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" briskcoin_en "${briskcoin_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" briskcoin_en "${briskcoin_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/briskcoin_en.xlf" "${briskcoin_en}")
