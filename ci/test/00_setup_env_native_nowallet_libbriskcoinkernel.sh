...
export CONTAINER_NAME=ci_native_nowallet_libbriskcoinkernel
...
export GOAL="install"
export BRISKCOIN_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
