...
```shell
llvm-cov show \
    --object=build/bin/test_briskcoin \
    --object=build/bin/briskcoind \
    ...
    --project-title="Briskcoin Core Coverage Report"
```
...
llvm-cov show \
    ...
    --show-expansions \
    --output-dir=build/coverage_report \
    --project-title="Briskcoin Core Fuzz Coverage Report"
```
...
Normally, these are maintained by active developers of Briskcoin Core, in which case
...
The tool instructions also include a list of the subtrees managed by Briskcoin Core.
...
- src/leveldb
  - Upstream at https://github.com/google/leveldb ; maintained by Google. Open
    important PRs to the Briskcoin Core subtree to avoid delay.
