Briskcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/briskcoin/files/Briskcoin/briskcoin-0.5.4/
...
http://gitorious.org/briskcoin/briskcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Briskcoin-Qt notifications under Growl 1.3.
Increase required age of Briskcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBriskcoin properly when installing Briskcoin-Qt over it. (Windows)
