Briskcoin Core version *0.15.2* is now available from:

  <https://briskcoincore.org/bin/briskcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in briskcoin-tx (TheBlueMatt)
