Briskcoin Core version *0.15.0.1* is now available from:

  <https://briskcoin.org/bin/briskcoin-core-0.15.0.1/>

and

  <https://briskcoincore.org/bin/briskcoin-core-0.15.0.1/>
