Briskcoin Core version 0.9.4 is now available from:

  https://briskcoin.org/bin/0.9.4/
...
this update is incompatible with the Briskcoin system and could lead to consensus
forks.

Briskcoin Core released binaries from https://briskcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~briskcoin/+archive/ubuntu/briskcoin
- A third-party or self-compiled Briskcoin Core

upgrade to Briskcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
