Briskcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/briskcoin/files/Briskcoin/briskcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Briskcoin
...
New/changed settings (command-line or briskcoin.conf file)
--------------------------------------------------------
