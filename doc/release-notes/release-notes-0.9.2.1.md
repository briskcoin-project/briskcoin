Briskcoin Core version 0.9.2.1 is now available from:

  https://briskcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BKC to 0.01 BKC
...
- Fix "Start briskcoin on system login"
