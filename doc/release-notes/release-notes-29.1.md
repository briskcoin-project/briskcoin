Briskcoin Core version 29.1 is now available from:

  <https://briskcoincore.org/bin/briskcoin-core-29.1/>
...
- #32389 doc: Fix test_briskcoin path
- #32607 rpc: Note in fundrawtransaction doc, fee rate is for package
- #32679 doc: update tor docs to use briskcoind binary from path
...
- #32719 doc, windows: CompanyName "Briskcoin" => "Briskcoin Core project"
