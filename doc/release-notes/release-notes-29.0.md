Briskcoin Core version 29.0 is now available from:

  <https://briskcoincore.org/bin/briskcoin-core-29.0/>
...
- A new tool [`utxo_to_sqlite.py`](https://github.com/briskcoin/briskcoin/blob/v29.0/contrib/utxo-tools/utxo_to_sqlite.py)
