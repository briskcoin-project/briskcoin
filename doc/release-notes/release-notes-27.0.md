Briskcoin Core version 27.0 is now available from:

  <https://briskcoincore.org/bin/briskcoin-core-27.0/>
...
libbriskcoinconsensus
-------------------

- libbriskcoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libbriskcoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Briskcoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Briskcoin Core would
