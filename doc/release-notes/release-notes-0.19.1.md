...
Briskcoin Core version 0.19.1 is now available from:

  <https://briskcoincore.org/bin/briskcoin-core-0.19.1/>
...
From Briskcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Briskcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Briskcoin Core does not yet change appearance when
...
- #17488 fix "briskcoind already running" warnings on macOS (fanquake)
