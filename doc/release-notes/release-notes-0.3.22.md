Download URL: https://sourceforge.net/projects/briskcoin/files/Briskcoin/briskcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BKC fee schedule (users still pay 0.01 BKC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #briskcoin00 - #briskcoin99
