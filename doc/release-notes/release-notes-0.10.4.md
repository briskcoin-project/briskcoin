Briskcoin Core version 0.10.4 is now available from:

  <https://briskcoin.org/bin/briskcoin-core-0.10.4/>
...
- #6953 `43c2789` Split briskcoin-tx into its own package
- #6953 `dfe0d4d` Include briskcoin-tx binary on Debian/Ubuntu
