Briskcoin Core version 0.16.1 is now available from:

  <https://briskcoincore.org/bin/briskcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting briskcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure briskcoind processes are cleaned up when tests end (sdaftuar)
