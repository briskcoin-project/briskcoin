Briskcoin Core version 0.13.2 is now available from:

  <https://briskcoin.org/bin/briskcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update briskcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow briskcoin-tx to create v2 transactions (bkcdrak)
