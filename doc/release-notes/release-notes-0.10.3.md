Briskcoin Core version 0.10.3 is now available from:

  <https://briskcoin.org/bin/briskcoin-core-0.10.3/>
...
(see https://github.com/briskcoin/briskcoin/pull/6793, as well as the 0.11.0
