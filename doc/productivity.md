...
```sh
cmake --build build --target briskcoind briskcoin-cli
cmake --build build --target briskcoin-qt
cmake --build build --target bench_briskcoin
```
...
> e.g. github.com/briskcoin/briskcoin.git or for the GUI github.com/briskcoin-core/gui
